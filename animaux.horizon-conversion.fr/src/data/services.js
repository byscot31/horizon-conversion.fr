...
exports.SERVICES = {
    "seo-local": {
        ...
        headline: "Optimisation GBP + pages locales utiles pour capter des recherches “métier + ville” et générer appels / itinéraires / demandes.",
        deliverables: [
    ...
    "google-ads": {
        ...
        badge: "Leads rapides",
        headline: "Campagnes Search orientées RDV : intentions fortes, exclusions anti-parasites, extensions d’appel et landing pages dédiées.",
        deliverables: [
    ...
    "meta-ads": {
        ...
        headline: "Ciblage local + créas orientées confiance pour générer des demandes qualifiées (pas du volume inutile).",
        deliverables: [
    ...
    "landing-pages": {
        ...
        badge: "Plus de RDV",
        headline: "Pages conçues pour convertir : preuve, réassurance, CTA, FAQ, vitesse, et structure SEO propre.",
        deliverables: [
    ...
    "tracking": {
        ...
        headline: "Mesurer appels / formulaires / sources (SEO/Maps/Ads) pour décider vite et optimiser au lead.",
        deliverables: [
