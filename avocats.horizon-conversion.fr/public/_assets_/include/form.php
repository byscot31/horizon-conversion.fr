...
$toemails[] = array(
	...
	'name' => 'Horizon Conversion Avocats' // Your Name
);
...
$fromemail = array(
	'email' => 'no-reply@horizon-conversion.com', // Company's Email Address (preferably currently used Domain Name)
	'name' => 'Horizon Conversion Avocats' // Company Name
);
